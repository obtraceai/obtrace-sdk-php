...
final class ObtraceClient
{
    ...
    {
        $logger = $this->otel->getLoggerProvider()->getLogger('obtrace-sdk-php', '1.0.2');
    ...
    public function metric(string $name, float $value, string $unit = '1', array $context = []): void
    {
        ...
        $meter = $this->otel->getMeterProvider()->getMeter('obtrace-sdk-php', '1.0.2');
    ...
    public function span(
        ...
        $tracer = $this->otel->getTracerProvider()->getTracer('obtrace-sdk-php', '1.0.2');
